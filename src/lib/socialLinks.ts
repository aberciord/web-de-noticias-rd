// Datos de contacto y redes sociales del sitio. Edita solo aquí — el resto
// del código los lee de este archivo, así que un cambio aquí actualiza
// todo el sitio de una vez.
